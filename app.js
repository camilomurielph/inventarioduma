...
// ================================================================
//  CARGAR Y GUARDAR PRODUCTOS A TRAVÉS DEL WORKER
// ================================================================
...
// ================================================================
//  MODAL CUSTOM (reemplaza prompt/confirm)
// ================================================================
...
async function agregarProductoNuevo(categoria) {
  ...
  if (!categoriasSet.has(categoria)) {
